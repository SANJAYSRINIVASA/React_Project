  ...
  return (
    <nav className={styles.navbar}>
      ...
      <div className={styles.links}>
        ...
        <NavLink to='/Features' className={styles.nav_link}> Features </NavLink>
        <NavLink to='/Details' className={styles.nav_link}> Details </NavLink>
        <NavLink to='/Video' className={styles.nav_link}> Video </NavLink>
